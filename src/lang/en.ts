export default {
  route: {
    ...
    forwardManagement: {
      ...
      admins: {
        title: 'Forward',
        manage: 'Manage Forward'
      }
    },

    salesnpurchaseManagement: {
      title: 'Sales & Purchase Entry',
      admins: {
        title: 'Sales & Purchase Entry',
        manage: 'Manage Sales & Purchase Entry'
      }
    },
    ...
    locations: {
      ...
      volunteers: {
        title: 'Volunteer',
        manage: 'Manage Volunteer'
      },
      locationsPhotos: {
        title: 'Locations Photo',
        manage: 'Manage Locations Photo'
      },
      locationsAmenities: {
        title: 'Locations Amenity',
        manage: 'Manage Locations Amenity'
      }
    },
    discover: {
      title: 'Discover',
