  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select
        ...
        :placeholder="$t('user.role.enabled')"
        clearable = true
        class="filter-item"
        style="width: 130px"
        @change="handleFilter"
...
import { IUsersRoleData } from '@/api/types'
...
export default class extends Vue {
  ...
  private async getList() {
    try {
      ...
      const data: any = await getUsersRoles(getQuery(this.listQuery))
      this.list = data.data
  ...
  private handleDownload() {
    ...
    exportJson2Excel(
      tHeader,
      data,
      this.$tc('route.userManagement.userRoles.title')
    )
