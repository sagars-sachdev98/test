<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input
        v-model="listQuery.bankCustomerName"
      ...
      />
      <el-input
        v-model="listQuery.bankAccountNumber"
...
import { IBankData } from '@/api/types'
...
export default class extends Vue {
  ...
  private listQuery = {
    ...
    filter: {
      id: 'ne',
      enabled: 'eq',
      bankAccountNumber: 'cont',
      bankCustomerName: '$contL'
    }
  };
  ...
  private async getList() {
    try {
      ...
      const data: any = await getBank(getQuery(this.listQuery))
      this.list = data.data
  ...
  private handleDownload() {
    ...
    exportJson2Excel(
      tHeader,
      data,
      this.$tc('route.BankManagement.Banks.title')
    )
