...
import {
  getAdminsRoleById,
  defaultAdminsRoleData,
  updateAdminsRole,
  createAdminsRole
} from '@/api/adminsRoles'
...
export default class extends Vue {
  ...
  private postForm = Object.assign({}, defaultAdminsRoleData);
  ...
  created() {
    if (this.isEdit) {
      ...
      this.postForm = Object.assign({}, defaultAdminsRoleData)
    }
  ...
  private async fetchData(id: number) {
    try {
      const data: any = await getAdminsRoleById(id)
      this.postForm = data
      // Just for test
