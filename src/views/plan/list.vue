  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        :min-width="17"
        align="left"
        label="No of users purchased"
        prop="noOfUsersPurchased"
      />
...
import { IPlanData } from '@/api/types'
...
export default class extends Vue {
  ...
  private async getList() {
    try {
      ...
      const data: any = await getPlans(getQuery(this.listQuery))
      this.list = data.data
  ...
  private handleDownload() {
    ...
    exportJson2Excel(
      tHeader,
      data,
      this.$tc('route.planManagement.plans.title')
    )
