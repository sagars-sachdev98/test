      ...
      >
        ...
        >
          <el-date-picker
            ...
            @change="toIso(postForm.dateTimeOfStart)"
          />
        </el-form-item>
        ...
        <el-form-item
          label="Prize if >"
          style="margin-bottom: 20px;"
          prop="numberOfParticipantsLT"
        >
          <el-input
            v-model="postForm.numberOfParticipantsLT"
            name="numberOfParticipantsLT"
            style="width:50%"
            required
            placeholder="Number Of Participants"
          />
...
export default class extends Vue {
  ...
  // toIso(date:any){
  //   debugger
  //   this.postForm.dateTimeOfStart = moment(date || this.toIso).toString()
  //   debugger
    
  //   var newdate = moment(date1, 'DD-MM-YYYY').add(30, 'days')
  //   this.postForm.expiry = newdate.toISOString()
  //   debugger
  // }
  ...
  private calcDate() {
    var date = moment(this.postForm.dateTimeOfStart)
    var newdate = moment(date, 'DD-MM-YYYY').add(30, 'days')
    this.postForm.expiry = newdate.toISOString()
    debugger
  }
